        ...
        <div class="Corpo2">
            <div class="tabelaPessoa">
                ...
                <table class="table table-hover" style="background-color:#c9c9c9;">
                    <thead>
                        <tr>
                            <th scope="col" class="tableText" style="font-size: 30px; position: sticky; top: 0; background-color: rgb(7, 135, 255);;">ID</th>
                            <th scope="col" class="tableText" style="font-size: 30px; position: sticky; top: 0; background-color: rgb(7, 135, 255);;">Nome</th>
                            <th scope="col" class="tableText" style="font-size: 30px; position: sticky; top: 0; background-color: rgb(7, 135, 255);">CPF</th>
                            <th scope="col" class="tableText" style="font-size: 30px; position: sticky; top: 0; background-color: rgb(7, 135, 255);">OPERAÇÕES</th>
                            <th scope="col" class="tableText" style="font-size: 30px; position: sticky; top: 0; background-color: rgb(7, 135, 255);">CONTATOS
                            </th>
                        </tr>
                    </thead>
